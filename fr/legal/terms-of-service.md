...
description: "Conditions générales d'utilisation de Tooli, la plateforme IA belge pour les professionnels de la construction."
seo_title: "Conditions d'utilisation | Tooli"
seo_description: "Lisez les conditions d'utilisation de Tooli, la plateforme IA pour la construction belge."
...
L'utilisation de Tooli implique l'acceptation pleine et entière des présentes CGU, accessibles à tout moment dans le pied de page du site.
...
Il est interdit, notamment, de quelque manière que ce soit et quels que soient les moyens techniques utilisés, de tenter d'accéder à des zones non publiques du système, de poser un quelconque acte qui, à un quelconque moment, pourrait perturber le fonctionnement du Chatbot.

Il est par ailleurs interdit, notamment, de quelque manière que ce soit et quels que soient les moyens techniques utilisés, de recourir à tout système ou dispositif automatisé, tel que, sans que cette liste soit limitative, des robots, spiders, crawlers, « offline readers » ou tout outil similaire, dans le but de provoquer ou contribuer à des attaques par déni de service (y compris, mais sans s'y limiter, les DoS réseau, DoS applicatives, DDoS réseau, DrDoS ou DDoS applicatives), ou dans le but de générer ou manipuler des messages, requêtes ou interactions sur Tooli, ou d'influencer les échanges avec un autre Utilisateur, y compris lorsqu'il répond à une requête formulée via la plateforme.

Il est interdit, de quelque manière que ce soit et quels que soient les moyens techniques utilisés, de télécharger, transmettre ou diffuser de quelque manière que ce soit tout contenu contraire aux lois ou réglementations en vigueur.

L'Utilisateur s'interdit de porter atteinte aux droits de propriété intellectuelle ou industrielle de tiers, et de télécharger, transmettre ou introduire tout contenu contenant des virus, malwares, chevaux de Troie, scripts nuisibles ou tout autre code, fichier ou programme conçu pour interrompre, endommager, perturber ou limiter le fonctionnement de Tooli, de ses logiciels, serveurs, réseaux, systèmes ou moyens de télécommunication, sans que cette énumération ne soit exhaustive ;

Il est tout autant interdit d'entreprendre toute action de nature à perturber, entraver ou limiter l'accès d'autres Utilisateurs à Tooli ou le bon fonctionnement de la plateforme.

## 5. Licence d'utilisation

L'Utilisateur obtient uniquement un droit d'accès et d'usage personnel de Tooli. À ce titre, il bénéficie d'une licence d'utilisation non exclusive, non transférable, non cessible et strictement limitée à un usage interne et non commercial. Cette licence est accordée pour la seule durée d'accès de l'Utilisateur à la plateforme.
...
Il est tout autant interdit à l'Utilisateur, lequel ne peut en aucun cas en autoriser un tiers, de procéder à toute forme d'ingénierie inverse, de décompilation, de désassemblage ou tenter de découvrir le code source de Tooli ou de ses composants.
...
En cas de désaccord sur le choix du médiateur, celui-ci sera désigné, à la demande de la Partie la plus diligente, par le Président du tribunal de l'entreprise francophone de Bruxelles, parmi les médiateurs agréés.

Une fois le médiateur désigné, les Parties fixeront, avec son assistance, les modalités pratiques de la médiation ainsi que la durée du processus. Chacune des Parties conserve la faculté d'y mettre fin à tout moment, sans préjudice, étant entendu qu'elles s'engagent au minimum à participer à une première séance de médiation. Sauf accord contraire, les frais de médiation seront supportés par moitié entre les Parties.
